...
export type RemoteAnalysisDetailBrowseProps<T> = {
  heading?: string;
  showHeading?: boolean;
 ...
 */
export function createRemoteAnalysisDetailBrowse(deps: AnalysisDetailBrowseDeps) {
  const {
    BrowseListControls,
  ...
  return function RemoteAnalysisDetailBrowse<T>({
    heading = "Detail data",
    showHeading = true,
